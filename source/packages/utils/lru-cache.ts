...
export class LRUCache<K extends {}, V extends {}, FC = unknown> {
  ...
  readonly #onInsert: LRUCache.Inserter<K, V> | undefined
   ...
   */
  sizeCalculation: LRUCache.SizeCalculator<K, V> | undefined
  /**
  ...
  #tail: Index
  #free: StackLike
  #disposed: DisposeTask<K, V>[] | undefined
  #sizes?: ZeroArray
  #starts?: ZeroArray
  #ttls?: ZeroArray
