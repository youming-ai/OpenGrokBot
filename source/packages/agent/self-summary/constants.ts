export const MAX_SELF_SUMMARY_RETRIES = 3;
export const SELF_SUMMARY_NUM_TURNS = 1_000;
export const SELF_SUMMARY_CONTEXT_WINDOW_FRACTION = 0.9;
export const SELF_SUMMARIZATION_PROMPT = `<user_query>
<summary_request>
...
export const ANTHROPIC_COMPACTION_INSTRUCTIONS = `You have written a partial transcript for the initial task above. Write a summary for continuity in a future context. Include state, next steps, and learnings. Wrap your summary in <summary></summary> tags. IMPORTANT: Do not call any tools. Respond immediately with only the <summary> block`;
export const CLAUDE_CODE_COMPACTION_PROMPT = `Your task is to create a detailed summary of the conversation so far, paying close attention to the user's explicit requests and your previous actions.
